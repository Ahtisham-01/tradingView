  ...
  import { createChart, CrosshairMode, IChartApi, ISeriesApi, DeepPartial, ChartOptions, AreaSeriesPartialOptions, Time ,LastPriceAnimationMode} from "lightweight-charts";
